# ==============================================================================
# POSTGRESQL ADAPTER - SQLAlchemy Async Implementation
# ==============================================================================
# Production-grade PostgreSQL adapter with connection pooling
# Full async/await support using asyncpg driver
# ==============================================================================
...
class PostgreSQLAdapter(BaseDatabaseAdapter[Any]):
    """
    PostgreSQL database adapter using SQLAlchemy async.
    
    Provides full async support with connection pooling, transaction
    management, and model registry for dynamic table mapping.
    
    Features:
        - Async connection pooling with configurable limits
        - Automatic session management with commit/rollback
        - Dynamic model registration for table mapping
    ...
    async def connect(self) -> None:
        ...
        Creates an async engine with connection pooling and
        configures the session factory for transaction management.
        """
        try:
